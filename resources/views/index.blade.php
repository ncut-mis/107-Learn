                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="slider_image full text_align_center">
                                                <img class="img-responsive" src="img/burger_slide.png" alt="#" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="img/blog_img1.png" alt="#"/>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="img/blog_img2.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Egg & Tosh</h3>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="img/blog_img3.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Pizza</h3>
    ...
    <div class="row">
      <div class="col-md-6 offset-md-3">
         <div class="Client_box">
           ...
           <i><img src="img/client_icon.png" alt="#"/></i>
         </div>
      </div>
    </div>
  </div>
